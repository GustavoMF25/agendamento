...
<html lang="pt-br">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?= BASED ?>/assets/images/sistemas/<?= isset($_SESSION['logo']) ? $_SESSION['logo'] : 'syntaxweb_logo.png' ?>">

        <!-- Calendar CSS -->
        <!-- <link href="<?= BASED ?>/assets/libs/@fullcalendar/core/main.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= BASED ?>/assets/libs/@fullcalendar/daygrid/main.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= BASED ?>/assets/libs/@fullcalendar/bootstrap/main.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= BASED ?>/assets/libs/@fullcalendar/timegrid/main.min.css" rel="stylesheet" type="text/css" /> -->
...
//                $(".table-responsive").responsiveTable()
    ...
    <body data-sidebar="light" class="vertical-collpsed" data-layout-mode="light">
        ...
        <script src="<?= BASEF ?>/vendor/assets/fullcalendar/dist/index.global.min.js"></script>
